...
background-image: url('/cdn/image/bg-auth.webp');
		        ...
		        <div class="pb-3">
		            ...
		            <div class="section shadow-5  p-3 akumauweb-rounded-sedang" style="margin-top: 5%;">
		                <div class="card-header ">
		                    <h1 class="font-semibold text-[24px] md:text-[28px] lg:text-[32px] leading-[150%] tracking-[0.3px] mt-5">Verifikasi Kode OTP</h1>
                            <p class="text-md mt-3 mb-2" style="color: rgb(203, 203, 203);">Masukkan Kode OTP yang telah kami kirim ke WhatsApp tujuan.</p>
                            <!--<b><h1 class="card-title">Verifikasi OTP</h1>-->
                            <hr>
                        </div>
		                <div class="card-body ">
		                  @if(session('success'))
                        	...
                        	<form role="form" action="{{ url('/verify/otp') }}" method="POST">
		                        @csrf		                        <div class="form-group mb-2">
		                          ...
		                          <input type="number" name="otp" class="form-control input-lg rounded-pill py-3 my-4" required autocomplete="off" placeholder="xxxxxx">
