                ...
                <div class="table-responsive">
                    <table class="table m-o">
                        ...
                        <tbody>
                            ...
                            }if($data_pesanan->success_report_sended == "0")
                            @endphp
                            <tr class="table-{{ $label_pesanan }}">
                                ...
                                <div class="btn-group-vertical">
                                        <button id="btnGroupDrop1" type="button" class="btn btn-{{$label_pesanan}} dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> {{ $data_pesanan->success_report_sended }} <i class="mdi mdi-chevron-down"></i> </button>
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <li><a class="dropdown-item" href="/resend/{{ $data_pesanan->order_id }}/0">Resend Report</a></li>
