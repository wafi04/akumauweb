                    ...
                    <table class="table m-o">
                        ...
                        <tbody>
                            ...
                            <tr class="table-{{ $label_pesanan }}">
                                ...
                                <td>{!! $data_pesanan->metode != "SP" ? $data_pesanan->no_pembayaran : '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Lihat QR</button>'!!}</td>
